...
- **Citations (Harvard):** in text `(Grupo Bimbo 2025, p. 45)`; a reference list
  in the appendix. Map the project's data tags. Use the parenthetical form —
  `(Grupo Bimbo, 2025, p. 45)` — not the narrative form ('Bimbo (2025) reports');
  the page-budget check recognizes only the parenthetical form. Harvard also
  accepts `(INEGI, n.d.)` for undated sources.
